...
response.sendRedirect("login.jsp?err=(Log in First)");
       ...
       String java=(String)request.getAttribute("java");
        ...
        if(quizname!=null)
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("deletequiz");
        ...
        <b><font size="5" face="constantia">      <table align="center" widht="1500" height="300"><form >
                ...
                <br>
               <tr><td>   C++ :</td><td><input type="radio" name="quizname" value="c++"></td><td><%= cpp %> questions are available for deletion</td></tr>
                 <br>
