<%-- 
    Document   : registrationteacher
    Created on : Jun 23, 2015, 9:16:09 PM
    Author     : SURESH
--%>
...
<html>
    <head><style>
        ...
        <title>Teacher registertaion</title>
    </head>
    <body  background="water.jpg" style="background-size:1400px;">
        <h1 align="center"><font face="constantia" size="20"><b><u>Teacher Registration</u></b></font></h1>
                            ...
                            <%
                                        ...
                                        if (name != null && password != null && confpassword != null && number != null && email != null) {
                                            ...
                                            if (name.length() < 1 || password.length() < 1 || confpassword.length() < 1 || number.length() < 1 || email.length() < 1 || confpassword.equals(password) == false || email.indexOf('@') == -1 || (number.length() >= 1 && number.length() < 10) || k == 1) {
                                                ...
                                                RequestDispatcher rd = request.getRequestDispatcher("registrationteacher");
                          ...
                          <font face="constantia" size="5"> <table align="center" width="700" height="300">
                                <form align="center" action="">
                                    ...
                                    <tr><td >Subject:</td><td><select name="subject">
                                                ...
                                                <option value="datastructure" name="data">DATA Structures</option>
                                            </select>
                                        </td></tr>
                            ...
                            </table></font><div style="padding-left: 900px; padding-top: 104px; "> <jsp:include page="layout.jsp"></jsp:include></div>
                            </body>
                            </html>
