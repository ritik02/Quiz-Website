...
String q="insert into message (frommsg,tomsg,msg) values('"+helper.beans.getEmail()+"','"+t+"','"+message+"');";
st.executeUpdate(q);
response.sendRedirect("welcomestudent.jsp?msg=!!Message Succesfully Sent!!");
