...
public class deleteaccount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String q;
            q="delete from "+helper.beans.getqwe()+" where email= '"+helper.beans.getEmail()+"';";
            s.executeUpdate(q);
            response.sendRedirect("login.jsp?msg=Account Successfully Deleted");
        ...
        {
            out.println("sorry" +e.getMessage());}finally {
            out.close();
        }
    } 
